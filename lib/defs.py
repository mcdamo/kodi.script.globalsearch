...
CATEGORIES = {
      'movies':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"or":[{{"field":"title", "operator":"contains", "value":"{query}"}},{{"field":"originaltitle", "operator":"contains", "value":"{query}"}}]}}',
                  'title':'{{"field":"title", "operator":"contains", "value":"{query}"}}',
                  'plot':'{{"field":"plot", "operator":"contains", "value":"{query}"}}',
                  'director':'{{"field":"director", "operator":"contains", "value":"{query}"}}',
                  'actor':'{{"field":"actor", "operator":"contains", "value":"{query}"}}',
      ...
      'musicvideos':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"or":[{{"field":"title", "operator":"contains", "value":"{query}"}}, {{"field":"artist", "operator":"contains", "value":"{query}"}}]}}',
                  'title':'{{"field":"title", "operator":"contains", "value":"{query}"}}',
                  'director':'{{"field":"director", "operator":"contains", "value":"{query}"}}',
                  'path':'{{"field":"path", "operator":"contains", "value":"{query}"}}',
                  'filename':'{{"field":"filename", "operator":"contains", "value":"{query}"}}',
