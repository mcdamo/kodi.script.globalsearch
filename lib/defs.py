...
CATEGORIES = {
      'movies':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"{andor}":[{{"field":"title", "operator":"{operator}", "value":"{query}"}},{{"field":"originaltitle", "operator":"{operator}", "value":"{query}"}}]}}',
                  'title':'{{"field":"title", "operator":"{operator}", "value":"{query}"}}',
                  'plot':'{{"field":"plot", "operator":"{operator}", "value":"{query}"}}',
                  'director':'{{"field":"director", "operator":"{operator}", "value":"{query}"}}',
                  'actor':'{{"field":"actor", "operator":"{operator}", "value":"{query}"}}',
                  'path':'{{"field":"path", "operator":"{operator}", "value":"{query}"}}',
                  'filename':'{{"field":"filename", "operator":"{operator}", "value":"{query}"}}',
            },
            'streamdetails':True,
            'label':342,
      ...
      'tvshows':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"field":"title", "operator":"{operator}", "value":"{query}"}}',
                  'title':'{{"field":"title", "operator":"{operator}", "value":"{query}"}}',
                  'plot':'{{"field":"plot", "operator":"{operator}", "value":"{query}"}}',
                  'director':'{{"field":"director", "operator":"{operator}", "value":"{query}"}}',
                  'actor':'{{"field":"actor", "operator":"{operator}", "value":"{query}"}}',
      ...
      'musicvideos':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"{andor}":[{{"field":"title", "operator":"{operator}", "value":"{query}"}}, {{"field":"artist", "operator":"{operator}", "value":"{query}"}}]}}',
                  'title':'{{"field":"title", "operator":"{operator}", "value":"{query}"}}',
                  'director':'{{"field":"director", "operator":"{operator}", "value":"{query}"}}',
                  'path':'{{"field":"path", "operator":"{operator}", "value":"{query}"}}',
                  'filename':'{{"field":"filename", "operator":"{operator}", "value":"{query}"}}',
      ...
      'artists':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"field":"artist", "operator":"{operator}", "value":"{query}"}}',
            },
            'streamdetails':False,
            'label':133,
      ...
      'albums':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"field":"album", "operator":"{operator}", "value":"{query}"}}',
                  'path':'{{"field":"path", "operator":"{operator}", "value":"{query}"}}',
            },
            'streamdetails':False,
            'label':132,
      ...
      'actors':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"field":"actor", "operator":"{operator}", "value":"{query}"}}',
                  'actor':'{{"field":"actor", "operator":"{operator}", "value":"{query}"}}',
            },
            'streamdetails':False,
            'label':32221,
      ...
      'directors':{
            ...
            'rule':'"filter":{query}',
            'filters':{
                  'default':'{{"field":"director", "operator":"{operator}", "value":"{query}"}}',
                  'director':'{{"field":"director", "operator":"{operator}", "value":"{query}"}}',
            },
            'streamdetails':False,
            'label':20348,
